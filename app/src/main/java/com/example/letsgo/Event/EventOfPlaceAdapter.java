...
public class EventOfPlaceAdapter extends RecyclerView.Adapter<EventOfPlaceAdapter.ViewHolder> {
    ...
    List<PlaceModel>getListOfPlaces(){
     ...
     EventOfPlaceAdapter(List<PlaceModel> listOfPlaces, Context context) {
